   ...
   //index of the array
      ...
      for (var plr in allPlayers) {
        ...
        if (index === player.index) {
          ...
          fill("pink") ;
          text("Player1 :" +allPlayers.player1.name,allPlayers.player1.positionX, allPlayers.player1.positionY-200) ;

          text("player2:"  +allPlayers.player2.name,allPlayers.player2.positionX, allPlayers.player2.positionY-200) ;
